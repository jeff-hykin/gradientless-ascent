...
try:
    from matplotlib import pyplot as _pyplot  # like this it doesn't show up in the interface
except ImportError:
    _pyplot = None
    _warnings.warn("Could not import matplotlib.pyplot, therefore" " ``cma.plot()`` etc. is not available")
